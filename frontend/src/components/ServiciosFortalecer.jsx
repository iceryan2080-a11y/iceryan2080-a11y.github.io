...
import { Shield, Activity, Lock, Brain, Eye, AlertOctagon } from 'lucide-react';
import { serviciosFortalecer } from '../mock';
...
const iconMap = {
  ...
  3: <Brain size={28} />,
  4: <Eye size={28} />,
  5: <AlertOctagon size={28} />,
};

const ServiciosFortalecer = () => {
  return (
      ...
      <div style={styles.container}>
        <div style={styles.header}>
          ...
          <p className="body-large" style={styles.intro}>
            Estos servicios reducen el riesgo de ataques y mejoran la postura de seguridad de forma constante.
          </p>
        </div>

        <div style={styles.servicesGrid}>
          {serviciosFortalecer.map((servicio, index) => (
...
export default ServiciosFortalecer;